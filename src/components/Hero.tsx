...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -right-20 -top-12 h-48 w-48 rounded-full bg-blush/25 blur-3xl md:-right-24 md:top-24 md:h-96 md:w-96 md:bg-blush/50" />
